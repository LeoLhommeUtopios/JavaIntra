...
@Import(org.example.testcontainerkafka.KafkaTestContainersLiveTest.KafkaTestContainersConfiguration.class)
@SpringBootTest(classes = TestContainerKafkaApplication.class)
@DirtiesContext
